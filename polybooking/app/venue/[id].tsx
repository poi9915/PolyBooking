...
import {Dimensions, Linking, Platform, ScrollView, StyleSheet, View} from "react-native";
...
export default function Venue() {
    ...
    const openGoogleMapWithCode = (location_code: string | null) => {
        if (location_code == null) return
        const encoded = encodeURIComponent(location_code)
            ...
            <ScrollView>
                <Card className="m-3 shadow-md" style={styles.fabCard}>
                    ...
                    <VStack space="md" className="p-4">
                        ...
                        <Link onPress={() => {
                            openGoogleMapWithCode(activeVenue.location_code)
