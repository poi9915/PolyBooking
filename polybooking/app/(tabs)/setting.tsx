...
export default function Setting() {
    ...
    const handleUpdateProfile = async () => {
        ...
        // Nếu avatarUrl là một đường dẫn local (bắt đầu bằng 'file://'), upload nó lên
        ...
        if (error) {
            ...
            await setProfile(data); // Cập nhật profile trong store
                    ...
                    <VStack space="lg" className="p-4">
                        ...
                        <VStack space="lg" className="pt-4">
                            ...
                            <FormControl>
                                ...
                                <Input>
                                    <InputField value={username} onChangeText={setUsername} placeholder="Nhập tên của bạn" />
                                </Input>
                            </FormControl>
                            <FormControl>
                                <FormControlLabel><FormControlLabelText>Số điện thoại</FormControlLabelText></FormControlLabel>
                                <Input>
                                    <InputField value={phone} onChangeText={setPhone} placeholder="Nhập số điện thoại" keyboardType="phone-pad" />
                                </Input>
                            </FormControl>
                        </VStack>
                    </VStack>
    ...
    // Lấy chữ cái đầu của username để làm fallback cho Avatar
